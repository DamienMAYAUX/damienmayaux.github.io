...
coauthors: "[Kevin M. Frick](https://kmfrick.github.io/), 
[Yagan Hazard](https://yaganhazard.github.io/), 
[Thomas Zuber](https://sites.google.com/view/thomaszuber/accueil)"
excerpt: 'With a corpus of job vacancies and a pinch of deep learning, we created a representation of occupations that captures how hard it is to reconvert from one to another, with application to the evaluation of training programs for jobseekers'
...
paperurl: 'https://www.insee.fr/en/statistiques/fichier/8679062/04_ES547_Frick-et-al_EN.pdf'
