...
excerpt: 'With a corpus of job vacancies an a pinch of deep learning, we created a representation of occupations that captures how hard it is to reconvert from one to another, with application to the evaluation of training programs for jobseekers'
